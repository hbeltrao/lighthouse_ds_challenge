...
# lighthouse_ds_challenge documentation build
...
from lighthouse_ds_challenge import __version__ as release

# -- Project information -----------------------------------------------------

project = "lighthouse_ds_challenge"
author = "Kedro"
...
htmlhelp_basename = "lighthouse_ds_challengedoc"
...
latex_documents = [
    (
        master_doc,
        "lighthouse_ds_challenge.tex",
        "lighthouse_ds_challenge Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "lighthouse_ds_challenge",
        "Project lighthouse_ds_challenge codebase.",
        "Data-Science",
    )
]
